<div>
    ...
    <div class="mx-auto bg-gray-900 rounded-lg shadow-md max-w-2sm border-amber-200">
        ...
        <form wire:submit="update" class="m-4 text-white ">
            @csrf
            <div>
            ...
            <div class="mt-6 p-4 bg-gray-800 rounded-lg">
                ...
                @if (!empty($existingFiles))
                    <div class="mb-6">
                        <h4 class="mb-3 text-sm font-medium text-gray-300">Archivos existentes:</h4>
                        <div class="space-y-2">
                            @foreach ($existingFiles as $file)
                                <div class="flex items-center justify-between p-3 bg-gray-700 rounded">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <span class="text-sm text-gray-300">{{ $file->original_name }}</span>
                                            <p class="text-xs text-gray-400">{{ $file->formatted_file_size }}</p>
                                        </div>
                                    </div>
                                    <div class="flex space-x-2">
                                        ...
                                        <button type="button" wire:click="deleteExistingFile({{ $file->id }})"
                ...
                @if (!empty($files))
                    <div class="mb-4">
                        <h4 class="mb-2 text-sm font-medium text-gray-300">Archivos nuevos seleccionados:</h4>
                        <div class="space-y-2">
