<div class="text-white">
    <!-- Título responsivo -->
    <h3 class="text-center text-lg md:text-xl font-semibold mb-3 md:mb-4">Nivel de Correspondencia</h3>
    ...
    <div class="mb-4 md:mb-6">
        <div class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3">
            <input type="text" 
                   ...
                   id="ncs"
                   placeholder="Ingrese nivel de correspondencia"
    ...
    <!-- Lista de Niveles de Correspondencia -->
    <div class="space-y-2 md:space-y-3">
        <h4 class="text-sm md:text-base font-medium text-gray-300 mb-2 md:mb-3">Niveles Registrados:</h4>
        @foreach($nncor as $items)
            <div class="flex justify-between items-center p-2 md:p-3 bg-gray-800 rounded-lg hover:bg-gray-750 transition-colors">
                <span class="text-white text-sm md:text-base">{{ $items->ncor }}</span>
                <div class="flex space-x-1 md:space-x-2">
                    ...
                    <button wire:click="deleteNcor({{ $items->id }})"
