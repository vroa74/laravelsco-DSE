            ...
            <div class="grid grid-cols-4 gap-1 w-full h-full px-4 text-white text-xs">
                ...
                <div class="border-2 border-gray-400 rounded-lg p-1 text-center flex flex-col items-center space-y-1">
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="text"
                               ...
                               wire:model.live="filname"
                               class="p-1 border rounded bg-gray-50 text-xs dark:bg-gray-700" style="width: 150px;">
                    </div>
                    <div class="flex items-center space-x-2">
                        <label
                            for="rfc"
                            class="text-sm text-gray-900 dark:text-white">RFC</label>
                        <input type="text"
                               id="rfc"
                               placeholder="RFC"
                               wire:model.live="filrfc"
                               class="p-1 border rounded bg-gray-50 text-xs dark:bg-gray-700" style="width: 150px;">
                    </div>
                    <div class="flex items-center space-x-2">
                        <label
                            for="curp"
                            class="text-sm text-gray-900 dark:text-white">CURP</label>
                        <input type="text"
                               id="curp"
                               placeholder="CURP"
                               wire:model.live="filcurp"
                               class="p-1 border rounded bg-gray-50 text-xs dark:bg-gray-700" style="width: 150px;">
                    </div>
                </div>
                <div class="border-2 border-gray-300 rounded-lg p-1 text-center flex flex-col items-center space-y-1">
                    ...
                    <div class="flex items-center space-x-2">
                        <label
                            for="sex"
                            class="text-sm text-gray-900 dark:text-white">Sexo</label>
                        <select
                               id="sex"
                               wire:model.live="filsex"
                               class="p-1 border rounded bg-gray-50 text-xs dark:bg-gray-700" style="width: 150px;">
                ...
                <div class="border-2 border-gray-400 rounded-lg p-1 text-center flex flex-col items-center space-y-1">
                    <div class="flex items-center space-x-2">
                        <label
                            for="lvl"
                            class="text-sm text-gray-900 dark:text-white">Nivel</label>
                        <select
                               id="lvl"
                               wire:model.live="fillvl"
                               class="p-1 border rounded bg-gray-50 text-xs dark:bg-gray-700" style="width: 150px;">
                    ...
                    <div class="flex items-center space-x-2">
                        <label
                            for="direction"
                            class="text-sm text-gray-900 dark:text-white">Dirección</label>
                        <select
                               id="direction"
                               wire:model.live="fildirection"
                               class="p-1 border rounded bg-gray-50 text-xs dark:bg-gray-700" style="width: 150px;">
                    ...
                    @foreach($users as $items)
                        <tr class="bg-white border-b text-xs dark:bg-gray-800 dark:border-gray-700
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                @else
                                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center mx-auto text-white font-semibold text-sm">
                            ...
                            <td class="px-6 py-4 whitespace-normal break-words w-20">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $items->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
            ...
            <div class="relative w-full max-w-2xl h-auto bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-4 bg-gray-500 text-white">
                    ...
                    <p><strong>Foto de Perfil:</strong> 
                        ...
                        @else
                            <div class="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center mt-1 text-white font-semibold text-lg">
    ...
    @if($editRecordId)
        <div id="edit-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 flex justify-center items-center w-full p-4 overflow-x-hidden overflow-y-auto h-modal md:h-full bg-gray-900 bg-opacity-50">
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-2 gap-4 bg-gray-900 p-1">
                        ...
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            ...
                            <input wire:model="editName" type="text" class="w-full p-2 border rounded dark:bg-gray-800 text-black" placeholder="Nombre completo">
                            @error('editName') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            <label class="block text-sm font-medium mb-1">Email:</label>
                            <input wire:model="editEmail" type="email" class="w-full p-2 border rounded dark:bg-gray-800 text-black" placeholder="correo@ejemplo.com">
                            @error('editEmail') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        
                        <!-- Fila 2 -->
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            <label class="block text-sm font-medium mb-1">RFC:</label>
                            <input wire:model="editRfc" type="text" class="w-full p-2 border rounded dark:bg-gray-800 text-black" placeholder="RFC (13 caracteres)" maxlength="13">
                            @error('editRfc') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            <label class="block text-sm font-medium mb-1">CURP:</label>
                            <input wire:model="editCurp" type="text" class="w-full p-2 border rounded dark:bg-gray-800 text-black" placeholder="CURP (18 caracteres)" maxlength="20">
                            @error('editCurp') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        
                        <!-- Fila 3 -->
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            <label class="block text-sm font-medium mb-1">Cargo:</label>
                            <select wire:model="editPosition" class="w-full p-2 border rounded dark:bg-gray-800 text-black">
                        ...
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            ...
                            <select wire:model="editLvl" class="w-full p-2 border rounded dark:bg-gray-800 text-black">
                        ...
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            ...
                            <select wire:model="editSex" class="w-full p-2 border rounded dark:bg-gray-800 text-black">
                        ...
                        <div class="bg-gray-500 text-white p-1 rounded-lg">
                            ...
                            <select wire:model="editTipo" class="w-full p-2 border rounded dark:bg-gray-800 text-black">
            ...
            <div class="bg-gray-500 text-white p-1 rounded-lg">
                ...
                <select wire:model="editStatus" class="w-full p-2 border rounded dark:bg-gray-800 text-black">
            ...
            <div class="bg-gray-500 text-white p-1 rounded-lg">
                ...
                <select wire:model="editDirection" class="w-full p-2 border rounded dark:bg-gray-800 text-black">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="w-16 h-16 rounded-full overflow-hidden flex items-center justify-center">
                        @if($editProfilePhoto)
                            ...
                            <img src="{{ $editProfilePhoto->temporaryUrl() }}" alt="Vista previa" class="w-full h-full object-cover">
                        @elseif($editProfilePhotoPath)
                            <!-- Foto actual del usuario -->
                            <img src="{{ asset('storage/' . $editProfilePhotoPath) }}" alt="Foto de perfil actual" class="w-full h-full object-cover">
                        @else
                    ...
                    <div class="flex-1">
                        <input wire:model.live="editProfilePhoto" type="file" accept="image/*" class="w-full p-2 border rounded dark:bg-gray-800 text-black text-sm">
                        <p class="text-xs text-gray-300 mt-1">Formatos: JPG, PNG, GIF. Máximo 2MB</p>
                        @if($editProfilePhoto)
                            <p class="text-xs text-green-300 mt-1">Archivo seleccionado: {{ $editProfilePhoto->getClientOriginalName() }}</p>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="relative w-full max-w-2xl h-auto bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-2 gap-4 bg-gray-900 p-1">
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        <label>Nombre:</label>
                        <input wire:model="newName" type="text" class="w-full p-2 border rounded dark:bg-gray-800" placeholder="Nombre completo" required>
                    </div>
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        <label>RFC:</label>
                        <input wire:model="newRfc" type="text" class="w-full p-2 border rounded dark:bg-gray-800" placeholder="RFC (13 caracteres)" maxlength="13">
                    </div>
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        <label>CURP:</label>
                        <input wire:model="newCurp" type="text" class="w-full p-2 border rounded dark:bg-gray-800" placeholder="CURP (18 caracteres)" maxlength="20">
                    </div>
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        <label>Cargo:</label>
                    ...
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        <label>Email:</label>
                        <input wire:model="newEmail" type="email" class="w-full p-2 border rounded dark:bg-gray-800" placeholder="correo@ejemplo.com">
                    </div>
                </div>
                <div class="grid grid-cols-1 gap-4 p-1">
                    ...
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        ...
                        <input wire:model="newPassword" type="password" class="w-full p-2 border rounded dark:bg-gray-800" placeholder="Mínimo 8 caracteres" required>
                        @error('newPassword') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                    </div>
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        <label>Confirmar Contraseña:</label>
                        <input wire:model="newPasswordConfirmation" type="password" class="w-full p-2 border rounded dark:bg-gray-800" placeholder="Confirmar contraseña" required>
                        @error('newPasswordConfirmation') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                    </div>
                    <div class="bg-gray-500 text-white p-1 rounded-lg">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="w-16 h-16 rounded-full overflow-hidden flex items-center justify-center">
                                @if($newProfilePhoto)
                                    <img src="{{ $newProfilePhoto->temporaryUrl() }}" alt="Vista previa" class="w-full h-full object-cover">
                                @else
                                    <div class="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-semibold text-xl">
                                        <i class="fa-solid fa-user-plus text-2xl"></i>
                                    </div>
                            ...
                            <div class="flex-1">
                                <input wire:model.live="newProfilePhoto" type="file" accept="image/*" class="w-full p-2 border rounded dark:bg-gray-800 text-sm">
                                <p class="text-xs text-gray-300 mt-1">Formatos: JPG, PNG, GIF. Máximo 2MB</p>
                                @if($newProfilePhoto)
                                    <p class="text-xs text-green-300 mt-1">Archivo seleccionado: {{ $newProfilePhoto->getClientOriginalName() }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
