...
{{--            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="http://laravelsco-dse.test/media/img/background_x.svg" alt="Laravel background" />--}}
            <img id="background" class="absolute -left-20 top-0 max-w-[877px] opacity-10 " src="{{ asset('media/img/background.png') }}" alt="Laravel background" />
                        ...
                        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div class="hidden sm:ml-6 sm:block">
                                <div class="flex space-x-4">
                                    ...
                                    <!-- Enlace Team -->
                                    <a href="{{ route('of1') }}"
                                       class="{{ request()->is('of1') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}
                                               rounded-md px-3 py-2 text-sm font-medium"
                                       aria-current="page">
                                        Team p1
                                    </a>
                                    ...
                                    <!-- Enlace Calendar -->
                                    <a href="#"
                                       class="{{ request()->is('calendar*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}
                                                rounded-md px-3 py-2 text-sm font-medium">
                                        Calendar
                                    </a>
                                </div>
...
{{--                            </div>--}}
            ...
            {{--            <link id="background"  class="absolute -left-20 top-0 max-w-[877px]" href="{{ asset('media/img/background.png') }}">--}}
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-xl  text-green-500 dark:text-white"> Tema. </h2>

                                    <p class="mt-4 text-sm/relaxed text-md text-white">
                                        Contenido del tema.
                                    </p>
                                </div>
...
{{--                    <p> ++++++++++ -------}}
{{--                    <div x-data="{ message: '' }" x-init="message = window.Alpine ? '¡Alpine.js está funcionando correctamente!' : 'Alpine.js no está cargado.'">--}}
{{--                        <!-- Mostrar el mensaje en la página -->--}}
{{--                        <p x-text="message"></p>--}}
{{--                        </p>--}}

                    <footer class="py-20 text-center text-sm text-white dark:text-white/70">
                        Esta pagina web esta desarrollada <span class="text-red-700 font-bold text-sm ">  &copy;  </span> <span class="text-blue-700 font-bold"> BlackWolfSystems  </span> <span class="text-red-600"> {{ now()->year }} </span>  &reg;.
