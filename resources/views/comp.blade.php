<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto text-white sm:px-6 lg:px-8">
            <div class="pl-6 bg-white dark:bg-gray-800 mt-0.5 overflow-hidden shadow-xl  sm:rounded-lg">
                <h2>botones</h2>
            ...
            <div class="bg-white dark:bg-gray-800 mt-0.5 overflow-hidden shadow-xl sm:rounded-lg">
                <h2></h2>
