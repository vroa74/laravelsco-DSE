<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('media/img/ple_legis_65.png') }}" alt="Descripción de la imagen" height="50px"
                            width="100px">
                                ...
                                <button
                                    ...
                                    @else
                                        <div class="size-8 bg-gray-300 rounded-full flex items-center justify-center">
                                            <span
                                                class="text-gray-600 font-medium text-sm">{{ substr(Auth::user()->name, 0, 2) }}</span>
                                        </div>
                                    @endif
                                </button>
                            @else
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('reportgral') }}" :active="request()->routeIs('reportgral')">
                reportgral
            </x-responsive-nav-link>
