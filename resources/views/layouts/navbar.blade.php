        ...
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="flex shrink-0 items-center">
                    <img src="{{ asset('media/img/ple_legis_65.png') }}" alt="Descripción de la imagen" height="40px" width="80px" >
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('of3') }}"
                           class="{{ request()->is('of3') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}
                                                 rounded-md px-3 py-2 text-sm font-medium">
                            Clasificación y Validación
                        </a>
                        <a href="{{ route('of4') }}"
                           class="{{ request()->is('of4') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}
                                                 rounded-md px-3 py-2 text-sm font-medium">
                            Registro Oficial
                        </a>
                        <a href="{{ route('of5') }}"
                           class="{{ request()->is('of5') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}
                                                 rounded-md px-3 py-2 text-sm font-medium">
